...
import Customize from '../../Components/Single Component/Customize';
import Recommendation from "../../Components/Single Component/Recommendation";

export default function TeracottaTile() {
    ...
    return (
        <>
            ...
            <BrickFilter filters={filters} onFilterChange={setFilters} title={"Teracotta Tile"} />
